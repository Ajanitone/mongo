...
function getSubject(template) {
  switch (template) {
    case "welcome":
      return "Welcome to our Trikania-herbs 🌿";

    case "forgotpass":
      return "Instructions on how to change your password at Trikania-herbs 🌿";
    default:
      "";
  }
}
...
export default async function main(token, template) {
  const data = {
    from: 'Trikania-herbs 🌿" <ajanitones@gmail.com>', // sender address
